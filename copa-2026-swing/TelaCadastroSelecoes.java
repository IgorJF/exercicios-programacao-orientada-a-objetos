...
public class TelaCadastroSelecoes {
	...
	private CadastroCopa2026 copa;

	public TelaCadastroSelecoes() {
		copa = new CadastroCopa2026();
	...
	private void cadastrar() {
		try{
			...
			SelecaoNacional selecao = new SelecaoNacional(nome, titulos, tecnico);
			copa.adicionarSelecao(selecao);
			listar();
		} 
		catch(NumeroDeTitulosNegativoException e){
	...
	private void pesquisar(){
		String nome = txtNome.getText();
		SelecaoNacional selecao = copa.pesquisarSelecao(nome);
	...
	private void listar(){
		...
		for (SelecaoNacional s : copa.listarSelecoes()){
